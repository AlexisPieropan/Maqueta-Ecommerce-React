    ...
    return(
        <div>
            <div className="w-11/12 m-auto py-10 ">
                <h1 className="text-xl font-bold ">Carro de Compras</h1>
                <p className="text-sm text-gray-400">Hay 1 item en tu carrito</p>
                                ...
                                <tr className="border-dashed border-b">
                                    <td className="py-5">
                                        <div className="flex items-center space-x-3 py-2">
                                            <img src={image} alt="lentes" className="w-[100px] h-[100px] border rounded p-2"/>
                                            <div>
                                                <h1 className="text-xl font-bold">Anteojo</h1>
                                                <p>Lorem ipsum dolor  debitis</p>
                                            </div>
                                        </div>
